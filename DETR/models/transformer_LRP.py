...
class TransformerEncoderLayer(nn.Module):
    ...
    def forward_post(self,
        ...
        src_drop = self.dropout1(src2_1)
        src = self.add1([src_3, src_drop])
        src = self.norm1(src)

        src2 = self.linear1(src2_2)
    ...
    def forward_post_relprop(self, cam_src, alpha, **kwargs):
        ...
        cam_src, cam_src2 = self.add2.relprop(cam_src, alpha, **kwargs)
        ...
        cam_src2_2 = self.linear1.relprop(cam_src2, alpha, **kwargs)

        cam_src = self.norm1.relprop(cam_src, alpha, **kwargs)
        cam_src_3, cam_src_drop = self.add1.relprop(cam_src, alpha, **kwargs)
        cam_src2_1 = self.dropout1.relprop(cam_src_drop, alpha, **kwargs)
        cam_src2 = self.clone3.relprop([cam_src2_1, cam_src2_2], alpha, **kwargs)
