...
from mmf.trainers.core.evaluation_loop import TrainerEvaluationLoopMixinOrig, TrainerEvaluationLoopMixin, TrainerEvaluationLoopMixinPert, TrainerEvaluationLoopMixinPerToken
...
@registry.register_trainer("mmf_orig")
class MMFTrainer(
    TrainerCallbackHookMixin,
    TrainerTrainingLoopMixin,
    TrainerDeviceMixin,
    TrainerEvaluationLoopMixinOrig,
...
@registry.register_trainer("mmf_per_token")
class MMFTrainer(
    TrainerCallbackHookMixin,
    TrainerTrainingLoopMixin,
    TrainerDeviceMixin,
    TrainerEvaluationLoopMixinPerToken,
    TrainerReportingMixin,
    TrainerProfilingMixin,
    BaseTrainer,
):
    ...
    def inference(self):
        ...
        for dataset in dataset_type:
            if self.config.evaluation.predict:
                ...
                logger.info(f"Starting inference on {dataset} set")
                self.evaluation_loop(
                    getattr(self, f"{dataset}_loader"), self.on_test_end
                )
